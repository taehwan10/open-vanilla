...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM jbd3

#if !defined(_TRACE_JBD3_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_JBD3_H
...
DECLARE_EVENT_CLASS(jbd3_commit,
...
DEFINE_EVENT(jbd3_commit, jbd3_start_commit,
...
DEFINE_EVENT(jbd3_commit, jbd3_commit_locking,
...
DEFINE_EVENT(jbd3_commit, jbd3_commit_flushing,
...
DEFINE_EVENT(jbd3_commit, jbd3_commit_logging,
...
DEFINE_EVENT(jbd3_commit, jbd3_drop_transaction,
...
TRACE_EVENT(jbd3_submit_inode_data,
...
DECLARE_EVENT_CLASS(jbd3_handle_start_class,
...
DEFINE_EVENT(jbd3_handle_start_class, jbd3_handle_start,
	TP_PROTO(dev_t dev, tid_t tid, unsigned int type,
		 unsigned int line_no, int requested_blocks),
...
DEFINE_EVENT(jbd3_handle_start_class, jbd3_handle_restart,
	TP_PROTO(dev_t dev, tid_t tid, unsigned int type,
		 unsigned int line_no, int requested_blocks),
...
TRACE_EVENT(jbd3_handle_extend,
	TP_PROTO(dev_t dev, tid_t tid, unsigned int type,
...
TRACE_EVENT(jbd3_checkpoint_stats,
	TP_PROTO(dev_t dev, tid_t tid,
...
TRACE_EVENT(jbd3_update_log_tail,
...
TRACE_EVENT(jbd3_write_superblock,
...
TRACE_EVENT(jbd3_lock_buffer_stall,
...
DECLARE_EVENT_CLASS(jbd3_journal_shrink,
...
DEFINE_EVENT(jbd3_journal_shrink, jbd3_shrink_count,
...
DEFINE_EVENT(jbd3_journal_shrink, jbd3_shrink_scan_enter,
...
TRACE_EVENT(jbd3_shrink_scan_exit,
...
TRACE_EVENT(jbd3_shrink_checkpoint_list,
