...
/*
 * KUnit test of pxt4 inode that verify the seconds part of [a/c/m]
 * timestamps in pxt4 inode structs are decoded correctly.
 */
...
KUNIT_ARRAY_PARAM(pxt4_inode, test_data, timestamp_expectation_to_desc);
 ...
 *  Documentation/filesystems/pxt4/inodes.rst.
 */
static void inode_test_xtimestamp_decoding(struct kunit *test)
{
	...
	timestamp = pxt4_decode_extra_time(
...
static struct kunit_case pxt4_inode_test_cases[] = {
	KUNIT_CASE_PARAM(inode_test_xtimestamp_decoding, pxt4_inode_gen_params),
	{}
};

static struct kunit_suite pxt4_inode_test_suite = {
	.name = "pxt4_inode_test",
	.test_cases = pxt4_inode_test_cases,
};

kunit_test_suites(&pxt4_inode_test_suite);
