...
extern void pxt4_es_insert_extent(struct inode *inode, pxt4_lblk_t lblk,
				  pxt4_lblk_t len, pxt4_fsblk_t pblk,
				  unsigned int status);
extern void pxt4_es_cache_extent(struct inode *inode, pxt4_lblk_t lblk,
				 pxt4_lblk_t len, pxt4_fsblk_t pblk,
				 unsigned int status);
extern void pxt4_es_remove_extent(struct inode *inode, pxt4_lblk_t lblk,
				  pxt4_lblk_t len);
...
static inline pxt4_fsblk_t pxt4_es_show_pblock(struct extent_status *es)
{
	pxt4_fsblk_t pblock = pxt4_es_pblock(es);
...
extern void pxt4_es_insert_delayed_block(struct inode *inode, pxt4_lblk_t lblk,
					 bool allocated);
